...
from haruka.modules.helper_funcs.chat_status import user_admin, is_user_ban_protected, can_delete
...
CLEAN_WELCOME = CommandHandler("clearjoin", clean_welcome, pass_args=True, filters=Filters.group)
